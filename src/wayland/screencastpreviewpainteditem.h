...
class ScreenCastPreviewPaintedItem : public QQuickPaintedItem
{
    Q_OBJECT
    QML_ELEMENT
...
public:
    explicit ScreenCastPreviewPaintedItem(QQuickItem *parent = nullptr);
    ~ScreenCastPreviewPaintedItem() override;
...
private:
    QRectF targetRect(const QSize &imageSize) const;
